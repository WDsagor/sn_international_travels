...
const TicketRow = ({ ticket, onEdit, onDelete }) => {
  ...
  return (
    <tr className="hover:bg-blue-50/50 transition-colors text-xx">
      ...
      <td className="px-4 py-3">
        ...
        <div className="relative group w-max mt-0.5">
          <div className="text-xx text-blue-600 font-semibold flex items-center gap-1 cursor-pointer hover:text-blue-800 transition-colors">
            {ticket?.route}
          </div>

          <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 hidden group-hover:flex group-hover:flex-col items-center gap-1.5 bg-gray-900 text-white text-xx rounded-lg py-1.5 shadow-xl z-50 whitespace-nowrap animate-in fade-in zoom-in-95 pointer-events-none">
